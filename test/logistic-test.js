...
tape("randomLogistic(a, b) returns random numbers with a mean of a", test => {
...
tape("randomLogistic(a, b) returns random numbers with a variance of (b * pi)^2 / 3", test => {
...
tape("randomLogistic(a, b) returns random numbers with a skewness of zero", test => {
...
tape("randomLogistic(a, b) returns random numbers with an excess kurtosis of 1.2", test => {
