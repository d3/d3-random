...
tape("randomGeometric(p) returns random geometrically distributed numbers with a mean of 1 / p.", test => {
...
tape("randomGeometric(p) returns random geometrically distributed numbers with a variance of (1 - p) / p^2.", test => {
...
tape("randomGeometric(p) returns random geometrically distributed numbers with a skewness of (2 - p) / sqrt(1 - p).", test => {
...
tape("randomGeometric(p) returns random geometrically distributed numbers with a kurtosis excess of (p^2 - 6 * p + 6) / (1 - p).", test => {
