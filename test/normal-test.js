...
it("randomNormal() returns random numbers with a mean of zero", () => {
  ...
  assertInDelta(mean(range(10000).map(r())), 0, .05);
});
...
it("randomNormal() returns random numbers with a standard deviation of one", () => {
  ...
  assertInDelta(deviation(range(10000).map(r())), 1, .05);
});
...
it("randomNormal(mu) returns random numbers with the specified mean", () => {
  ...
  assertInDelta(mean(range(10000).map(r(42))), 42, .05);
  assertInDelta(mean(range(10000).map(r(-2))), -2, .05);
});
...
it("randomNormal(mu) returns random numbers with a standard deviation of 1", () => {
  ...
  assertInDelta(deviation(range(10000).map(r(42))), 1, .05);
  assertInDelta(deviation(range(10000).map(r(-2))), 1, .05);
});
...
it("randomNormal(mu, sigma) returns random numbers with the specified mean and standard deviation", () => {
  ...
  assertInDelta(mean(range(10000).map(r(42, 2))), 42, .05);
  assertInDelta(mean(range(10000).map(r(-2, 2))), -2, .05);
  assertInDelta(deviation(range(10000).map(r(42, 2))), 2, .05);
  assertInDelta(deviation(range(10000).map(r(-2, 2))), 2, .05);
});
